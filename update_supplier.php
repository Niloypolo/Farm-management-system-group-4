...
if(isset($_POST['submit'])){
  ...
  $sql="update `supplier` set Supplier_ID='$id',Supplier_Name='$supplier_name', Contact_Number='$number', Email='$email' where Supplier_ID=$id";
...
<html lang="en">
  <head>
    ...
    <title>FarmPro Update Supplier</title>
  </head>
  <body>
